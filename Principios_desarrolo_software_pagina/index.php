...
$Consulta = "SELECT * FROM vivalavidasinestres WHERE Correo='$id_usuario'";
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="#" data-bs-toggle="modal" data-bs-target="#usuariomodal"><?php echo $Nombres;?></a></li>
          ...
          <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
              <div class="modal-header">
                <h3 id="exampleModalLabel"><?php echo $Nombres; ?></h3>
              </div>
<?php
  }
}
?>
              ...
              <div class="modal-footer">
                <a href="php/cerrar_sesion.php" class="btn btn-secondary col-md-4">Cerrar Sesión</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item" data-bs-interval="3000">
                <img src="./Imagenes/ruta1.png" class="d-block w-100" alt="..."  height="800px" title="Estudios sobre nanotecnología">
              </div>
   ...
   <div class="contenedor-servicio">
    ...
    <div class="checklist-servicio">
      <div class="service">
        ...
        <p>Al apretar acá, se desplegara las opciones de rutas que ofrecemos, al elegir una de estas, se te pedira
          una confirmación del pedido de ruta, y cuando ingreses al bus deberas elegir el boton ingrese al bus,
           al bajarte deberas ingresar ya baje del bus</p>
      </div>
 
<!--Colapsar-->
<p>
<button class="btn btn-outline-dark" id="btnservicio" type="button" data-bs-toggle="collapse" data-bs-target="#rutacollapseExample" aria-expanded="false" aria-controls="collapseExample">
  ¡Comienza ahora!
</button>
</p>
<div class="collapse" id="rutacollapseExample">
<div class="card card-body">
  <h2>Rutas de Buses</h2>
 <div class="btn-group" role="group" aria-label="Basic outlined example">
  <a class="btn btn-outline-secondary" href="FuncionesBuzzes.html" role="button">Envigado</a>
  <a class="btn btn-outline-secondary" href="sabaneta.html" role="button">Sabaneta</a>
  <a class="btn btn-outline-secondary" href="sabaneta.html" role="button">Envigado2</a>
</div>
</div>
</div>
<!--acaba el colapse-->
...
<button type="button" class="btn btn-outline-dark" id="btnservicio" data-bs-toggle="modal" data-bs-target="#mimodal">
Dale un vistazo
</button>
...
<!--horarios-->
  <div class="service">
    ...
    <p>Los horarios registrados de cada ruta se podran visualizar, en caso de que una ruta aun no este en operacion 
      este se mostrara de color rojo, si si esta operando se mostrara de colo verde</p>
  </div>

<!--Colapsar-->
<p>
<button class="btn btn-outline-dark" id="btnservicio" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
  ¡Comienza ahora!
</button>
</p>
...
<!--offcanva-->
<button class="btn btn-outline-dark" id="btnservicio" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas" aria-controls="offcanvas">Calcula aquí </button>
...
<div class="offcanvas-body">
    ...
    <button class="btn btn-ligth" type="button" id="btnservicio" onclick="calcular()">Calcular</button><br><br>
    <p id="resultado"></p>
</div>
</div>
<!--acaba offcanva-->
       ...
       <div class="row">
        ...
        <div class="col-sm">
          <div class="card w-100 card-border mb-5">
            <img src="./imagenes/SIUUUU.png" class="card-img-top" alt="..." height="250px">
            <div class="card-body">
              <h5 class="card-title"> Párrafo de prueba </h5>
              <p class="card-text"> Párrafo de prueba <br> Párrafo de prueba </p>
            </div>
          </div>
        </div>
              ...
              <div class="row g-0">
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="card-text"> Párrafo de prueba</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <img src="./img/...." class="w-100" alt="...">
        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
          <div class="accordion-item">
            ...
            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">Párrafo de prueba  (aprieta click) </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">Párrafo de prueba
              </div>
            </div>
          </div>
          <div class="accordion-item">
